<template>
  <div>
    ...
    <transition name="fade">
      <div v-show="isOpen" class="barContent am-flexbox am-flexbox-dir-column">
        <div v-for="tmpObj in countryList" class="barContent-items am-flexbox am-flexbox-align-stretch">
          ...
          <div class="barContent-country am-flexbox am-flexbox-dir-column am-flexbox-justify-center am-flexbox-align-top text-xs">
          <span v-for="tmpCountry in getCountrySpan(tmpObj.country)" >
...
<style scoped>
  ...
  .barContent-triangleUp{
    ...
    border-bottom: 0.17rem solid #2bbea6;
    position: absolute;
    float: left;
    left:12%;
    top:1.28rem;
